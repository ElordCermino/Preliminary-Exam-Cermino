...
I started by creating a new repository on GitHub named **21st Century IT Skills Preliminary Exam — Cermino, Joe Elord** under my account. I initialized it with a `README.md` so it would have a landing page from the start after creating the repository remotely.
